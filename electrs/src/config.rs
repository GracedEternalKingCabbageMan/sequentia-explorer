    ...
    pub fn from_args() -> Config {
        ...
        let parent_network = m
            ...
            .unwrap_or_else(|| match network_type {
                ...
                // XXX liquid testnet/regtest + Sequentia don't index a Bitcoin parent here
                Network::LiquidTestnet | Network::LiquidRegtest | Network::SequentiaTestnet => {
                    BNetwork::Regtest
                }
            });
        ...
        let default_daemon_port = match network_type {
            ...
            Network::Liquid => 7041,
            #[cfg(feature = "liquid")]
            Network::LiquidTestnet | Network::LiquidRegtest | Network::SequentiaTestnet => 7040,
        };
        let default_electrum_port = match network_type {
            ...
            #[cfg(feature = "liquid")]
            Network::SequentiaTestnet => 51402,
        };
        ...
        let default_monitoring_port = match network_type {
            ...
            #[cfg(feature = "liquid")]
            Network::SequentiaTestnet => 44424,
        };
...
pub fn get_network_subdir(network: Network) -> Option<&'static str> {
    match network {
        ...
        // SEQUENTIA chain=test stores blocks under the testnet3 datadir subdir.
        #[cfg(feature = "liquid")]
